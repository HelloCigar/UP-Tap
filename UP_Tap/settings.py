...
# SECURITY WARNING: keep the secret key used in production secret!, see https://djecrety.ir/
SECRET_KEY = os.getenv('DJANGO_SECRETKEY', 'django-insecure-)#4-r355t&9w0@1c6=m1lq*)xan31b#!h6dgz3v*_@2f*c0qp2')
...
DJOSER = {
    ...
    'EMAIL_FRONTEND_SITE_NAME': 'UP Tap',
}