...
\begin{figure}[h] % 'h' places the figure approximately here in the text
	\centering
	\includegraphics[width=0.55\textwidth]{figures/chapter4/student_form_pc.png} % Adjust width as needed
...
\begin{figure}[h] % 'h' places the figure approximately here in the text
	\centering
	\includegraphics[width=0.55\textwidth]{figures/chapter4/student_form_mobile.jpg} % Adjust width as needed
